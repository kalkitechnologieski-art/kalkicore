    ...
    <header className="fixed top-0 left-0 right-0 z-50 glass border-b border-white/10 backdrop-blur-xl">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="flex items-center justify-between h-20">
          ...
          {/* Right side: theme toggle (desktop), Start Project, Hamburger */}
          <div className="flex items-center gap-3">
            {/* Desktop theme toggle (small sparkle) */}
            ...
            {/* Hamburger – now always visible on mobile with proper class */}
            <button
      ...
      {/* Mobile Menu – overlay with blur backdrop */}
      <AnimatePresence>
        {isMenuOpen && (
          <motion.div
            initial={{ opacity: 0 }}
          ...
          >
            ...
            >
              ...
              {/* Navigation items – each as voltage-button */}
